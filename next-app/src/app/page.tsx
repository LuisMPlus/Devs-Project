    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <button
          ...
          className="group inline-flex items-center gap-3 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 border border-[var(--color-primary)]"
          style={{
            backgroundColor: 'color-mix(in srgb, var(--color-primary) 12%, transparent)',
            color: 'var(--color-primary)',
            boxShadow: '0 8px 32px color-mix(in srgb, var(--color-primary) 15%, transparent)',
          }}
        >
